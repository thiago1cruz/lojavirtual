        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(snapshot.get('title'),textAlign: TextAlign.start, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17),),
          ...
          Row(
            ...
            children: [
              TextButton(
                  style: TextButton.styleFrom(primary: Colors.blue, padding: EdgeInsets.zero),
                  onPressed: (){
